...
<c:choose>
	<c:when test="${avg ge 90}"><c:set var="grd" value="수"/></c:when>
	<c:when test="${avg ge 80}"><c:set var="grd" value="우"/></c:when>
	<c:when test="${avg ge 70}"><c:set var="grd" value="미"/></c:when>
	<c:when test="${avg ge 60}"><c:set var="grd" value="양"/></c:when>
	<c:otherwise>
		<c:set var="grd2" value="가"/>
	</c:otherwise>
</c:choose>
